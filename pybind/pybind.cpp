...
PYBIND11_MODULE(carticulate, m) {
    ...
    py::class_<ESKF_IMU>(m, "ESKF")
        ...
        .def("get_gravity_correction_confidence", [](const ESKF_IMU &eskf) { return eskf.get_detector().gravity_correction_confidence(); }, "get gravity correction confidence")
        .def("get_magnetic_correction_confidence", [](const ESKF_IMU &eskf) { return eskf.get_detector().magnetic_correction_confidence(); }, "get magnetic correction confidence")
        .def("get_gyrobias_correction_confidence", [](const ESKF_IMU &eskf) { return eskf.get_detector().gyrobias_correction_confidence(); }, "get gyrobias correction confidence")
